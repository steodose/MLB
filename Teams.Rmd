...
mlb_standings %>% 
    ...
    geom_hline(yintercept = mean(mlb_standings$RS), color = "red", linetype = "dashed") +
    geom_vline(xintercept =  mean(mlb_standings$RA), color = "red", linetype = "dashed") +
    theme_custom() +
...
projections <- read_csv("/Users/Stephan/Desktop/R Projects/MLB/conensus_projections_2025.csv")
...
expectations %>% 
  ...
  labs(x = "", 
       y = "Win % over Expected", 
       caption = "Data: baseballR (Bill Petti/FanGraphs/Odds API | Plot: @steodosescu",
       title = glue("Performance Relative to Preseason Expecations"),
       subtitle = glue("Actual win percentage vs. Predicted. Estimated totals pulled from various source systems as of March 26, 2025.")) +
  theme(plot.title.position = "plot",
        plot.title = element_text(face = "bold", 
                                  size = 20, 
                                  hjust = 0.5
...
2025 Attendance statistics coming soon...

```{r attendance, echo = FALSE}

# load attendance data
attendance <- baseballr::mlb_attendance(league_list_id = 'mlb', season = 2024)
...
attendance %>% 
  ...
  labs(x = "", 
       ...
       subtitle = glue("Average home attendance totals in 2024. Thru **{today}.**")) +
  theme(plot.title.position = "plot",
        plot.title = element_text(face = "bold", 
                                  size = 20, 
                                  hjust = 0.5
